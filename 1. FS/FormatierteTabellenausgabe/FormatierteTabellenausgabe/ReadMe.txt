========================================================================
    KONSOLENANWENDUNG: FormatierteTabellenausgabe-Projektübersicht
========================================================================

Diese FormatierteTabellenausgabe-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre FormatierteTabellenausgabe-Anwendung besteht.


FormatierteTabellenausgabe.vcxproj
...
FormatierteTabellenausgabe.vcxproj.filters
...
FormatierteTabellenausgabe.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen FormatierteTabellenausgabe.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
