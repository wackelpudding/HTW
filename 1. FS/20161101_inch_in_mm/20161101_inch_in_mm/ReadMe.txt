========================================================================
    KONSOLENANWENDUNG: 20161101_inch_in_mm-Projektübersicht
========================================================================

Diese 20161101_inch_in_mm-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 20161101_inch_in_mm-Anwendung besteht.


20161101_inch_in_mm.vcxproj
...
20161101_inch_in_mm.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 20161101_inch_in_mm.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
