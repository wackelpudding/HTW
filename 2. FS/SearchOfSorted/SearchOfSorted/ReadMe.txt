========================================================================
    KONSOLENANWENDUNG: SearchOfSorted-Projektübersicht
========================================================================

Diese SearchOfSorted-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre SearchOfSorted-Anwendung besteht.


SearchOfSorted.vcxproj
...
SearchOfSorted.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen SearchOfSorted.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
