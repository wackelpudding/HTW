========================================================================
    KONSOLENANWENDUNG: EinfachVerketteteListen-Projektübersicht
========================================================================

Diese EinfachVerketteteListen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre EinfachVerketteteListen-Anwendung besteht.


EinfachVerketteteListen.vcxproj
...
EinfachVerketteteListen.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen EinfachVerketteteListen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
