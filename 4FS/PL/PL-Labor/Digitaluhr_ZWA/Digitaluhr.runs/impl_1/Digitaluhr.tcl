...
set rc [catch {
  ...
  set_property ip_repo_paths {{i:/HTW/4. FS/PL-Labor/Digitaluhr_ZWA/Digitaluhr.cache/ip}} [current_project]
  set_property ip_output_repo {{i:/HTW/4. FS/PL-Labor/Digitaluhr_ZWA/Digitaluhr.cache/ip}} [current_project]
  add_files -quiet {{I:/HTW/4. FS/PL-Labor/Digitaluhr_ZWA/Digitaluhr.runs/synth_1/Digitaluhr.dcp}}
