========================================================================
    KONSOLENANWENDUNG: SortAndConvert-Projektübersicht
========================================================================

Diese SortAndConvert-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre SortAndConvert-Anwendung besteht.


SortAndConvert.vcxproj
...
SortAndConvert.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen SortAndConvert.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
